    ...
    <>
      ...
      <div className="App">
        <div className='row gap-5'>
          <div className="block col-5 m-3" onDragOver={handleDragOver} onDrop={(e) => handleDrop(e, 'today')}>
            <h2>Today</h2>
          ...
          <div className="block col-5 m-3" onDragOver={handleDragOver} onDrop={(e) => handleDrop(e, 'tomorrow')}>
            <h2>Tomorrow</h2>
        ...
        <div className='row gap-5'>
          <div className="block col-5 m-3" onDragOver={handleDragOver} onDrop={(e) => handleDrop(e, 'thisWeek')}>
            <h2>This Week</h2>
          ...
          <div className="block col-5 m-3" onDragOver={handleDragOver} onDrop={(e) => handleDrop(e, 'nextWeek')}>
            <h2>Next Week</h2>
        ...
        <div className="block w-25 mx-auto" onDragOver={handleDragOver} onDrop={(e) => handleDrop(e, 'unplanned')}>
          <h2>Unplanned</h2>
